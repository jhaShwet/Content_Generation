...
if st.button("Generate Content"):
    if topic:
        response = requests.post("https://content-gen-backend.onrender.com/generate/", json={"topic": topic})
...
if 'content' in st.session_state.content_data:
    ...
    if st.button("Submit Content"):
        ...
        submit_response = requests.post("https://content-gen-backend.onrender.com/submit/", json={"content_id": content_id})
